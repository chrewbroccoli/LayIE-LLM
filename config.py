...
folder_path_reg_md = "gpt4_Markdown_outputs/reg/outputs"
folder_path_ad_md = "gpt4_Markdown_outputs/ad/outputs"
dataset_path_reg = "vrdu2/registration-form/main/dataset.jsonl.gz"
dataset_path_ad = "vrdu2/ad-buy-form/main/dataset.jsonl.gz"

defined_schema = {
    "file_date": r'\d{4}-\d{2}-\d{2}',  # Matches nopredictionsrmalized date format (YYYY-MM-DD)
    "foreign_principle_name": r'[\w\s.,\'&-]+',  # Allows common characters, whitespace, and punctuation
    "registrant_name": r'[\w\s.,\'&-]+',  # Similar to foreign_principle_name
    "registration_num": r'\d+',  # Matches digits only after cleaning
    "signer_name": r'[\w\s\'.-]+',  # Matches capitalized first and last names
    "signer_title": r'[\w\s.,\'&-]+',  # Matches job titles with common characters and punctuation
}
...
prompt_md = """
You will be provided with an image of a document. Extract all the information you can find and return it in a Markdown format. Do not include any additional text, explanations, comments, or formatting outside of Markdown. Ensure all keys and values are properly presented in the Markdown. If you could not find value of key just write "" for the value.
"""

prompt_reg_img = """
You will be provided with an image of a document. Extract the following information and return it in JSON format. Do not include any additional text, explanations, comments, or formatting. Ensure that all keys and values are properly escaped and do not include special characters that might break the JSON format. The JSON object should include the following keys:

1. file_date: The date when the document was filed.
2. foreign_principle_name: The name of the foreign principal involved.
3. registrant_name: The name of the registrant.
4. registration_num: The registration number of the document.
5. signer_name: The name of the person who signed the document.
6. signer_title: The title of the person who signed the document.

Here is an example format:
{
    "file_date": "value",
    "foreign_principle_name": "value",
    "registrant_name": "value",
    "registration_num": "value",
    "signer_name": "value",
    "signer_title": "value"
}

If you could not find value of key just write "" instead of "value".
"""
...
Here is an example format:
    {
        "advertiser": "", "agency": "", "contract_num": "", "flight_from": "", "flight_to": "", "gross_amount": "", 
        "line_item": [{"channel": "", "program_desc": "", "program_end_date": "", "program_start_date": "","sub_amount": ""}], 
        "product": "", "property": "", "tv_address": ""
    }
